                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-manufacturer-tab" data-toggle="pill"
                                href="#pills-man
                                ufacturer" role="tab" aria-controls="pills-manufacturer"
            ...
            <div class="row justify-content-center no-gutters">
                <div class="col-md-10 d-flex align-items-center">
                    <div class="services-wrap rounded-right w-100">
                        <h3 class="heading-section text-center mb-4">Apa lagi Yang Kamu Tunggu?</h3>
                        <div class="row d-flex mb-4">
                            ...
                            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                                <div class="services w-100 text-center">
                                    ...
                                    <div class="text w-100">
                                        <h3 class="heading mb-2">Pilih Harga Yang Sesuai</h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <p class="text-center mt-5"><a href="{{ route('car.sewa', $car->slug) }}"
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            ...
            <h2 class="mb-2">Mobil Yang Terkait</h2>
        </div>
    </div>
    <div class="row">
        @foreach ($related_cars as $r_car)
            <div class="col-md-4">
            <div class="car-wrap rounded ftco-animate">
                <div class="img rounded d-flex align-items-end"
                    style="background-image: url({{ Storage::url($r_car->thumbnail) }});">
                </div>
                <div class="text">
                    <h2 class="mb-0"><a href="{{ route('car.show', $r_car->slug) }}">{{ $r_car->title }}</a></h2>
                    <div class="d-flex mb-3">
                        <p class="price ml-auto">Rp. {{ $r_car->price }} <span>/day</span></p>
                    </div>
                    <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-primary py-2 mr-1">Pesan</a> <a
                            href="{{ route('car.show', $r_car->slug) }}" class="btn btn-secondary py-2 ml-1">Details</a></p>
                </div>
            </div>
        </div>
        @endforeach
